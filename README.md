# Оглавление
[Перед компиляцией и установкой](#Перед-компиляцией-и-установкой)
[Получение Client-ID и Streamer-ID](#Получение-Client-ID-и-Streamer-ID)
[Компиляция](#Компиляция)
[Инструкция в картинках для Windows](#Инструкция-в-картинках-для-Windows)
[Инструкция в картинках для Linux](#Инструкция-в-картинках-для-Linux)
____
